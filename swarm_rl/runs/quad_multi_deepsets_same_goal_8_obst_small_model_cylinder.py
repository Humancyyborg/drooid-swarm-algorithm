...
_params = ParamGrid([
    ...
    ('quads_mode', ['o_dynamic_same_goal']),
])

SMALL_MODEL_CLI = QUAD_8_OBSTACLES_PARAMETERZE_CLI + (
    ' --hidden_size=16 --quads_neighbor_hidden_size=8 --quads_obstacle_hidden_size=8 --num_workers=36'
)

_experiment = Experiment(
    'same_goal-cylinder-small_model',
    SMALL_MODEL_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('8_obst_2_local_quads_multi_obst_same_goal_8a_v116', experiments=[_experiment])
