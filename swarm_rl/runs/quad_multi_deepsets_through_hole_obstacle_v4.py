...
_params = ParamGrid([
    ...
    ('quads_obst_enable_sim', [True, False]),
    ('obst_obs_type', ['pos_size', 'pos_vel_size_shape']),
])

_experiment = Experiment(
    'gridsearch-use_sim-obst_obs_typr',
...
# Slurm
# srun --exclusive -c72 -N1 --gres=gpu:4 python -m sample_factory.runner.run --run=swarm_rl.runs.quad_multi_deepsets_through_hole_obstacle_v4 --runner=processes --max_parallel=4 --pause_between=1 --experiments_per_gpu=1 --num_gpus=4
