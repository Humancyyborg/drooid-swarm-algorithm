...
_experiment = Experiment(
    'local_obst_neighbor_deepsets_cube_fix_size_fall_off_3arm_v3',
...
# Slurm
# srun --exclusive -c72 -N1 --gres=gpu:4 python -m sample_factory.runner.run --run=swarm_rl.runs.quad_multi_deepsets_through_hole_obstacle_v3 --runner=processes --max_parallel=4 --pause_between=1 --experiments_per_gpu=1 --num_gpus=4
