...
_params = ParamGrid([
    ...
    ('quads_crash_mode', [0, 1]),
])

_experiment = Experiment(
    'v2_crash_2_local_obst_prox_penalty_mix',
    QUAD_OBSTACLE_PARAMETERZE_LONG_DURATION_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('v2_crash_quads_multi_obst_mix_8a_v116', experiments=[_experiment])
