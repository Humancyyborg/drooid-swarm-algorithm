...
_params = ParamGrid(
    [
        ...
        ("quads_cost_rl_mellinger", [0.1, 0.5]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    # SBC
    '--quads_enable_sbc=False '
    '--quads_cost_rl_sbc=0.0 --quads_sbc_boundary=0.0 --quads_sbc_radius=0.05 '
    ...
    '--wandb_group=grid_search_no_sbc_v1'
)

_experiment = Experiment(
    "grid_search_no_sbc_v1",
    OBSTACLE_MODEL_CLI,
