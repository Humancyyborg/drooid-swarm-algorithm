...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_max_acc", [6.0]),
        ("quads_max_neighbor_aggressive", [50.0, 200.0]),
        ("quads_max_obst_aggressive", [50.0, 200.0]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--wandb_group=quad_8_grid_search_sbc_aggressive_anneal'
)

_experiment = Experiment(
    "quad_8_grid_search_sbc_aggressive_anneal",
    OBSTACLE_MODEL_CLI,
