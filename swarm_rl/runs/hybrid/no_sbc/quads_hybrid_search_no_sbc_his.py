...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_obs_acc_his", [True]),
        ("quads_obs_acc_his_num", [1, 3, 5]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_max_acc=2.0 --quads_cost_enable_extra=False '
    # Obstacle
    ...
    '--wandb_group=grid_search_no_sbc_his'
)

_experiment = Experiment(
    "grid_search_no_sbc_his",
    OBSTACLE_MODEL_CLI,
