...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_cost_enable_extra", [True, False]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_obs_acc_his=False --quads_obs_acc_his_num=0 --quads_max_acc=2.0 --train_for_env_steps=2000000000 '
    # Obstacle
    '--quads_obst_density=0.8 --quads_obst_size=0.85 '
    # Reward Shaping
    '--quads_cost_rl_sbc=0.0 --quads_cost_rl_mellinger=0.0 --quads_sbc_boundary=0.0 --quads_cost_act_change=0.0 '
    ...
    '--wandb_group=grid_search_no_sbc_baseline_acc_5'
)

_experiment = Experiment(
    "grid_search_no_sbc_baseline_acc_5",
    OBSTACLE_MODEL_CLI,
