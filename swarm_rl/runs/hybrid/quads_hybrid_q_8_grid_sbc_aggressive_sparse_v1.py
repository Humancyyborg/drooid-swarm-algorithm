...
_params = ParamGrid(
    [
        ...
        ("quads_cost_sbc_mellinger", [0.05, 0.1, 0.2]),
    ]
)

OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ' --anneal_collision_steps=300000000 --quads_anneal_safe_start_steps=0 --quads_anneal_safe_total_steps=300000000 '
    '--quads_num_agents=8 --num_workers=36 --num_envs_per_worker=4 --quads_obst_density=0.2 --quads_obst_size=0.6 '
    '--quads_cost_rl_sbc=0.1 --quads_cost_pos=1.0 --quads_neighbor_range=3.0 '
    '--quads_obst_range=3.0 --quads_sbc_radius=0.05 --quads_obst_safe_coeff=1.0 --quads_sbc_boundary=0.1 '
    '--with_wandb=True --wandb_project=Quad-Hybrid --wandb_user=multi-drones '
    '--wandb_group=quad_8_sparse'
)
