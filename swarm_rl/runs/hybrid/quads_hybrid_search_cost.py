...
_params = ParamGrid(
    [
        ...
        ("quads_cost_cbf_agg", [0.0, 0.1]),
        ("quads_cost_rl_mellinger", [0.0, 0.1]),
        ("quads_cost_extra_rl_real", [0.0, 0.1]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_obs_acc_his=False --quads_max_acc=2.0 '
    # Obstacle
    '--quads_obst_density=0.8 --quads_obst_size=0.85 '
    # SBC
    '--quads_enable_sbc=True --quads_cost_rl_sbc=0.1 --quads_sbc_boundary=0.1 --quads_sbc_radius=0.05 '
    ...
    '--wandb_group=grid_search_cost_v2'
)
