...
SMALL_MODEL_CLI = QUAD_8_OBSTACLES_PARAMETERZE_CLI + (
    ...
    '--obst_obs_type=pos_vel_size --anneal_start_collision_steps=100000000 --anneal_collision_steps=300000000 '
    '--quads_obst_level=10000000000'
)

_experiment = Experiment(
    'anneal_col-physical-deploy-curri-16-hidden-cylinder-small_model',
    SMALL_MODEL_CLI,
