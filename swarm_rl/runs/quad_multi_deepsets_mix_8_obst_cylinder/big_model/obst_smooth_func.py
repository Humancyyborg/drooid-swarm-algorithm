...
_params = ParamGrid([
    ('seed', seeds(2)),
    ('quads_obst_penalty_fall_off', [3.0, 6.0]),
    ('quads_obst_smooth_penalty_mode', ['square']),
])
...
BIG_MODEL_CLI = QUAD_8_OBSTACLES_PARAMETERZE_CLI + (
    ...
    '--with_wandb=False --quads_extra_crash_reward=False --quads_obstacle_type=cylinder'
)

_experiment = Experiment(
    'obst_square_smooth-cylinder-big_model',
    BIG_MODEL_CLI,
