...
_params = ParamGrid([
    ('seed', seeds(2)),
    ('quads_larger_obst_encoder', [True]),
    ('obst_obs_type', ['posxy_size', 'cpoint']),
...
BIG_MODEL_CLI = QUAD_8_OBSTACLES_PARAMETERZE_CLI + (
    ...
    '--with_wandb=False --quads_extra_crash_reward=False --quads_obstacle_type=cylinder --num_workers=36'
)
