...
_params = ParamGrid([
    ...
    ('quads_obst_generation_mode', ['cube']),
    ('quads_obst_level_mode', [1]),
])
...
SMALL_MODEL_CLI = QUAD_8_OBSTACLES_PARAMETERZE_CLI + (
    ...
    '--with_wandb=False --quads_extra_crash_reward=False --quads_obstacle_type=cylinder --num_workers=48'
)

_experiment = Experiment(
    'obst_generation_mode_cube-cylinder-obst_16-small_model',
    SMALL_MODEL_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('16_obst_2_local_quads_multi_obst_mix_8a_v116', experiments=[_experiment])
