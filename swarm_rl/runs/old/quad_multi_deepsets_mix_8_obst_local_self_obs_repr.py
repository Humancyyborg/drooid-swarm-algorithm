...
_params = ParamGrid([
    ...
    ('quads_obs_repr', ['xyz_vxyz_R_omega', 'xyz_vxyz_R_omega_floor_cwallid_cwall']),
])

_experiment = Experiment(
    '8_obst_self_obs_repr_obst_prox_penalty_mix',
    QUAD_OBSTACLE_PARAMETERZE_LONG_DURATION_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('self_obs_repr_quads_multi_obst_mix_8a_v116', experiments=[_experiment])
