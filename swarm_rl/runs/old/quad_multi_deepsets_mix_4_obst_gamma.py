...
_params = ParamGrid([
    ...
    ('gamma', [0.99, 0.995, 0.998, 0.9999]),
])

_experiment = Experiment(
    'grid_gamma_four_obst_prox_penalty_mix',
    QUAD_OBSTACLE_PARAMETERZE_LONG_DURATION_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('grid_gamma_quads_multi_obst_mix_8a_v116', experiments=[_experiment])
