...
_params = ParamGrid([
    ...
    ('reward_scale', [0.06, 0.08]),
])

_experiment = Experiment(
    'grid_rew_scale_8_obst_prox_penalty_mix',
    QUAD_OBSTACLE_PARAMETERZE_LONG_DURATION_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('grid_rew_scale_quads_multi_obst_mix_8a_v116', experiments=[_experiment])
