...
_params = ParamGrid([
    ...
    ('quads_neighbor_rel_pos_mode', [0, 1]),
    ('quads_obst_rel_pos_mode', [0, 1]),
])

_experiment = Experiment(
    'nei_obst_8_obst_2_local_obst_prox_penalty_mix',
    QUAD_OBSTACLE_PARAMETERZE_LONG_DURATION_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('nei_obst_8_obst_2_local_quads_multi_obst_mix_8a_v116', experiments=[_experiment])
