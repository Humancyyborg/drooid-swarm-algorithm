...
_params = ParamGrid([
    ...
    ('quads_reward_ep_len', [True, False]),
])

_experiment = Experiment(
    'test_scale_o_dynamic_same_goal',
    QUAD_OBSTACLE_PILLAR_BASELINE_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('test_scale_quads_multi_obst_o_dynamic_same_goal_8a_v116', experiments=[_experiment])
