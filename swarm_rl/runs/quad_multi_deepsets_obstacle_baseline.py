...
QUAD_8_OBSTACLES_PARAMETERZE_CLI = (
    ...
    '--quads_obs_repr=xyz_vxyz_R_omega_wall --quads_obst_midreset=True --quads_obst_col_reset_threshold=2 '
    '--with_wandb=True --wandb_tags obst_quad num_collisions rew_pos --wandb_user=zhehui'
)
