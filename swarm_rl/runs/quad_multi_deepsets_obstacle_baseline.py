...
QUAD_SINGLE_NO_OBSTACLES_PARAMETERZE_CLI = (
    ...
    '--quads_num_agents=1 --replay_buffer_sample_prob=0.0 --anneal_collision_steps=0.0 '
...
QUADS_8_MULTI_NO_OBSTACLES_PARAMETERZE_CLI = (
    ...
    '--quads_neighbor_hidden_size=16 --neighbor_obs_type=pos_vel --quads_neighbor_encoder_type=mean_embed '
    '--quads_local_obs=6 --quads_local_obst_obs=0 --quads_local_metric=dist --quads_local_coeff=1.0 '
    '--quads_num_agents=8 --replay_buffer_sample_prob=0.0 --anneal_collision_steps=0.0 '
    '--save_milestones_sec=10000 --reward_scale=1.0 --quads_enable_sim_room=wall-ceiling --gamma=0.99 '
    '--quads_crash_mode=1 --quads_obs_repr=xyz_vxyz_R_omega_wall '
    '--with_wandb=True --wandb_user=multi-drone'
)
