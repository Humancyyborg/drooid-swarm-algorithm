...
from swarm_rl.runs.quad_multi_deepsets_obstacle_baseline import QUAD_OBSTACLE_PILLAR_HARD_CLI
...
_experiment = Experiment(
    'hard_through_pillar',
    QUAD_OBSTACLE_PILLAR_HARD_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('hard_quads_multi_obst_through_pillar_8a_v116', experiments=[_experiment])
