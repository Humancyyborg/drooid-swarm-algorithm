...
_params = ParamGrid([
    ...
    ('quads_obst_encoder_type', ['mean_embed', 'mlp']),
])

_experiment = Experiment(
    'model_four_obst_prox_penalty_mix',
    QUAD_OBSTACLE_PARAMETERZE_LONG_DURATION_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('model_quads_multi_obst_mix_8a_v116', experiments=[_experiment])
