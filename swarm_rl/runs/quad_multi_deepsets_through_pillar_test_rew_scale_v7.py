...
_params = ParamGrid([
    ...
    ('reward_scale', [0.2]),
    ('quads_collision_obst_smooth_max_penalty', [100]),
])

_experiment = Experiment(
    'v7_test_scale_through_pillar',
    QUAD_OBSTACLE_PILLAR_BASELINE_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('v7_test_scale_quads_multi_obst_through_pillar_8a_v116', experiments=[_experiment])
