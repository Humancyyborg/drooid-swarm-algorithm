...
SINGLE_CLI = QUAD_BASELINE_CLI + (
    ...
    '--with_wandb=True --wandb_project=HyperPPO --wandb_group=single_num_batch_size_v2 --wandb_user=multi-drones'
)

_experiment = Experiment(
    'single_num_batch_size_v2',
    SINGLE_CLI,
...
# python -m sample_factory.launcher.run --run=swarm_rl.runs.single_quad.single_quad_batch_size_v2 --backend=processes --max_parallel=4 --pause_between=1 --experiments_per_gpu=1 --num_gpus=4
