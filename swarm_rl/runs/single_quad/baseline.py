...
QUAD_BASELINE_CLI = (
    ...
    '--num_workers=36 --num_envs_per_worker=8 --learning_rate=0.0001 --ppo_clip_value=5.0 --recurrence=1 '
    ...
    '--quads_neighbor_visible_num=0 --replay_buffer_sample_prob=0.0 --anneal_collision_steps=0 '
