...
QUAD_BASELINE_CLI = (
    ...
    '--num_workers=32 --num_envs_per_worker=8 --rollout=128 --batch_size=1024 --num_batches_per_epoch=1 '
    '--learning_rate=0.0001 --ppo_clip_value=5.0 --recurrence=1 --nonlinearity=tanh --actor_critic_share_weights=False '
    '--policy_initialization=xavier_uniform --adaptive_stddev=False --with_vtrace=False --max_policy_lag=100000000 '
    '--rnn_size=256 --with_pbt=False --gae_lambda=1.00 --max_grad_norm=5.0 --exploration_loss_coeff=0.0 '
