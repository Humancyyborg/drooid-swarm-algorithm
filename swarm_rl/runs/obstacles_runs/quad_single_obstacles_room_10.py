...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--with_wandb=True --wandb_project=Quad-Swarm-RL --wandb_group=one_drone_multi_obst_new_octomap_room_10 '
    '--wandb_user=multi-drones --anneal_collision_steps=300000000 --replay_buffer_sample_prob=0 --room_dims 10 10 10'
)

_experiment = Experiment(
    "one_drone_multi_obst_new_octomap_room_10",
    OBSTACLE_MODEL_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription("test_new_obst_octomap_room_10", experiments=[_experiment])
