...
_experiment = Experiment(
    'no_max_entropy-adaptive_stddev-8_agents',
    BIG_MODEL_CLI,
...
# python -m sample_factory.runner.run --run=swarm_rl.runs.multi.adaptive_stddev.quad_8_multi_mix_baseline_in_air_adaptive_stddev_no_max_entropy --runner=processes --max_parallel=4 --pause_between=1 --experiments_per_gpu=1 --num_gpus=4