...
# python -m sample_factory.runner.run --run=swarm_rl.runs.multi.adaptive_stddev.exploration.quad_8_multi_mix_baseline_in_air_explore_loss_1e-3_max_3e-3 --runner=processes --max_parallel=4 --pause_between=1 --experiments_per_gpu=1 --num_gpus=4