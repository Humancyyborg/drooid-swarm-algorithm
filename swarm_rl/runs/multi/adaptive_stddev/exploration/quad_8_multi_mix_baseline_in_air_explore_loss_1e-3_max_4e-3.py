...
_params = ParamGrid([
    ('seed', seeds(4)),
    ('exploration_loss_coeff', [0.0003]),
    ('max_entropy_coeff', [0.001]),
])
...
_experiment = Experiment(
    'exploration_loss-4e-3-adaptive_stddev-8_agents',
    BIG_MODEL_CLI,
...
# python -m sample_factory.runner.run --run=swarm_rl.runs.multi.adaptive_stddev.exploration.quad_8_multi_mix_baseline_in_air_explore_loss_1e-3_max_4e-3 --runner=processes --max_parallel=4 --pause_between=1 --experiments_per_gpu=1 --num_gpus=4