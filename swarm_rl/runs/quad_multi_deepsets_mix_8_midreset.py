...
_params = ParamGrid([
    ...
    ('quads_crash_reset_threshold', [200]),
    ('quads_midreset', [True, False]),
])

_experiment = Experiment(
    'mid_reset_2_local_obst_prox_penalty_mix',
    QUAD_OBSTACLE_PARAMETERZE_LONG_DURATION_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('midreset_8_obst_quads_multi_obst_mix_8a_v116', experiments=[_experiment])
