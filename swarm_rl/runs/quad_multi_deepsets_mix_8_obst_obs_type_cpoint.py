...
_params = ParamGrid([
    ...
    ('obst_obs_type', ['cpoint', 'pos_size']),
])

_experiment = Experiment(
    'obst_obs_type_2_local_obst_prox_penalty_mix',
    QUAD_OBSTACLE_PARAMETERZE_LONG_DURATION_CLI,
    _params.generate_params(randomize=False),
)

RUN_DESCRIPTION = RunDescription('obst_obs_type_8_obst_quads_multi_obst_mix_8a_v116', experiments=[_experiment])
