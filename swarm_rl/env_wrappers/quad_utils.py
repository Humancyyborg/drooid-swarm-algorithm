...
def make_quadrotor_env_multi(cfg, **kwargs):
    ...
    env = QuadrotorEnvMulti(
        ...
        obst_collision_enable_grace_period=cfg.quads_obst_collision_enable_grace_period, midreset=cfg.quads_midreset,
        crash_reset_threshold=cfg.quads_crash_reset_threshold
    )
