...
def add_quadrotors_env_args(env, parser):
    ...
    p.add_argument('--obst_obs_type', default='none', type=str, choices=['none', 'pos_size', 'pos_vel_size', 'pos_vel_size_shape'], help='Choose what kind of obs to send to encoder.')
