...
QUADS_MODE_LIST_OBSTACLES = ['o_uniform_goal_spawn']
...
QUADS_MODE_GOAL_CENTERS = ['o_swarm_groups', 'o_uniform_goal_spawn', 'o_uniform_diff_goal_spawn', 'o_uniform_swarm_vs_swarm']
