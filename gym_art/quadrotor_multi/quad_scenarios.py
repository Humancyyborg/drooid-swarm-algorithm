...
class Scenario_mix(QuadrotorScenario):
    def __init__(self, envs, num_agents, room_dims, rew_coeff, quads_formation, quads_formation_size):
        ...
        self.quads_formation_and_size_dict = {
            ...
            "static_diff_goal": [QUADS_FORMATION_LIST, [2 * quad_arm_size, 8 * quad_arm_size], 16.0, str_dynamic_obstacles], # [23, 46] centimeters
            "dynamic_diff_goal": [QUADS_FORMATION_LIST, [2 * quad_arm_size, 8 * quad_arm_size], 16.0, str_no_obstacles], # [23, 46] centimeters
            ...
            "dynamic_formations": [QUADS_FORMATION_LIST, [4 * quad_arm_size, 10 * quad_arm_size], 16.0, str_dynamic_obstacles]
        }
