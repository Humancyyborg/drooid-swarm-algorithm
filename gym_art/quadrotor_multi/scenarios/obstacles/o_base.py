...
class Scenario_o_base(QuadrotorScenario):
    def __init__(self, quads_mode, envs, num_agents, room_dims):
        ...
        self.duration_step = 0.0
        self.control_freq = envs[0].control_freq
    ...
    def step(self):
        ...
        self.duration_step = (self.envs[0].ep_time + 1) * self.control_freq
    ...
    def reset(self):
        ...
        self.duration_step = int(np.random.uniform(low=2.0, high=4.0) * self.control_freq)
