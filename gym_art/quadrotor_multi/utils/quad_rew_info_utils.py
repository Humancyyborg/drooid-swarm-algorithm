...
def get_collision_reward(num_agents, emergent_collisions, rew_coeff=0.0):
...
def get_collision_reward_room(num_agents, emergent_collisions_floor, emergent_collisions_walls,
                              emergent_collisions_ceiling, rew_coeff_floor=0.0, rew_coeff_walls=0.0,
                              rew_coeff_ceiling=0.0):
...
def set_collision_rewards(rewards, rew_floor, rew_walls, rew_ceiling, rew_collisions_neighbor,
...
def set_collision_infos(infos, rew_floor, rew_walls, rew_ceiling, rew_raw_floor, rew_raw_walls, rew_raw_ceiling,
                        rew_collisions_neighbor, rew_collision_proximity_neighbor, rew_collisions_obst=None,
                        rew_collision_proximity_obst=None):
    ...
    for i, info in enumerate(infos):
        ...
        infos[i]["rewards"]["rewraw_floor"] = rew_raw_floor[i]
        infos[i]["rewards"]["rewraw_walls"] = rew_raw_walls[i]
        infos[i]["rewards"]["rewraw_ceiling"] = rew_raw_ceiling[i]

        info["rewards"]["rew_quadcol"] = rew_collisions_neighbor[i]
        info["rewards"]["rew_proximity"] = rew_collision_proximity_neighbor[i]

    if len(rew_collisions_obst) > 0 or len(rew_collision_proximity_obst) > 0:
        for i, info in enumerate(infos):
            info["rewards"]["rew_quadcol_obstacle"] = rew_collisions_obst[i]
            info["rewards"]["rew_obst_quad_proximity"] = rew_collision_proximity_obst[i]

    return infos


def set_collision_rewards_infos(rewards, infos, rew_floor, rew_walls, rew_ceiling, rew_raw_floor, rew_raw_walls,
                                rew_raw_ceiling, rew_collisions_neighbor, rew_collision_proximity_neighbor,
    ...
    infos = set_collision_infos(infos=infos, rew_floor=rew_floor, rew_walls=rew_walls, rew_ceiling=rew_ceiling,
                                rew_raw_floor=rew_raw_floor, rew_raw_walls=rew_raw_walls,
                                rew_raw_ceiling=rew_raw_ceiling, rew_collisions_neighbor=rew_collisions_neighbor,
                                rew_collision_proximity_neighbor=rew_collision_proximity_neighbor,
                                rew_collisions_obst=rew_collisions_obst,
                                rew_collision_proximity_obst=rew_collision_proximity_obst)
