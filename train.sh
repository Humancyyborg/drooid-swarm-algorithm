...
--env=quadrotor_multi --train_for_env_steps=100000000 --algo=APPO --use_rnn=False --seed=0 \
--num_workers=12 --num_envs_per_worker=4 --learning_rate=0.0001 --ppo_clip_value=5.0 --recurrence=1 \
