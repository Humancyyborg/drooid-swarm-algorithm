...
setup(
    ...
    install_requires=[
        'pytest', 'numpy>1.15', 'pyglet<=1.5.23', 'matplotlib>3', 'gym>=0.17', 'transforms3d', 'noise', 'tqdm', 'bezier<=2020.5.19', 'numba', 'scipy',
        'sample-factory>=1.121.0', 'octomap-python', 'plotly<=5.13.0'
    ],
)
